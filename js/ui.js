...
const UI = {
    ...
    renderCategoryFilters(categories, onCategorySelect) {
        ...
        categories.forEach(category => {
            ...
            button.classList.add('filter-btn', 'bg-light-bg', 'dark:bg-dark-bg', 'border', 'border-light-border', 'dark:border-dark-border', 'px-4', 'py-2', 'rounded-md', 'font-medium', 'hover:bg-primary', 'hover:text-white', 'transition', 'duration-300');
